...
def main():
    ...
    while len(all_images) * args.batch_size < args.num_samples:
        ...
        sample = sample_fn(
            ...
            # hq_img_path="/mnt/HDD2/phudoan/custom-guided-diffusion/hq_img/academic_gown/000.jpg",
            # hq_img_path="/mnt/HDD2/phudoan/custom-guided-diffusion/hq_img/academic_gown/004.jpg",
            hq_img_path='/mnt/HDD2/phudoan/custom-guided-diffusion/hq_img/CelebDataProcessed/Barack Obama/4.jpg',
        )
