...
def main():
    ...
    repo_folder_path = "/mnt/HDD2/phudoan/custom-guided-diffusion/"    # (server 118 or 92)
    ...
    # load data
    batch_size = 1
    hq_img_folder = '/mnt/HDD2/phudoan/custom-guided-diffusion/hq_img/CelebDataProcessed/Barack Obama'
